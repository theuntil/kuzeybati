...
export const config = {
   ...
   * kırılıyor.
   */
  matcher: ["/((?!api|_next/static|_next/image|fonts|favicon.ico|robots.txt|sitemap.xml|manifest.webmanifest|icon|apple-icon|opengraph-image|.*\\.(?:png|jpg|jpeg|gif|webp|avif|svg|ico)).*)"],
};
